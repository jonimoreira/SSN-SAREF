...
\lstdefinelanguage{JavaScript}{
  morekeywords={typeof, new, true, false, catch, function, return, null, catch, switch, var, if, in, while, do, else, case, break, IN:, createTriple, Map, isnull, end},
  morecomment=[s]{/*}{*/},
  morecomment=[l]//,
  morestring=[b]",
  morestring=[b]'
...
\keywords{Semantic interoperability, internet-of-things, ontology alignment, ETSI SAREF, W3C SSN}
